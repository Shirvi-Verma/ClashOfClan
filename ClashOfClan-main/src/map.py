...
def printMap(V):
    ...
    for stealth in stealth_archers:
        a= 2*stealth.position[0]
        b = 2*stealth.position[1]
        map_matrix[a][b] = stealthColor(stealth) + Fore.BLACK + 'ST'
        map_matrix[a+1][b] = stealthColor(stealth) + Fore.BLACK + 'L '
        map_matrix[a][b+1] = stealthColor(stealth) + Fore.BLACK + 'EA'
        map_matrix[a+1][b+1] = stealthColor(stealth) + Fore.BLACK + 'TH'
